...
public class ViewCalculadora extends JFrame { //class
	...
	Double valor1, potencia=0.0,valor2, logaritmo; // váriaveis usadas para realizar os cálculos
	
	String sinal;
	private String digitosArray,recebeCampo,recebeArrayOp; 
	
	
	boolean logIniciado= false;
	int n, p;
	...
	public ViewCalculadora() {
		...
		// Botão de log base 10
		
		JButton btnLog = new JButton("log10n"); 
		btnLog.addActionListener(new ActionListener() {
				...
				sinal = "log10n"; 
				if (sinal == "log10n") {
					 logaritmo =   Math.log10(valor1) ;
					 txtResultado.setText (String.valueOf( logaritmo));
		...
		btnLog.setBounds(315, 285, 100, 45);
		btnLog.setFont(new Font("Arial", Font.PLAIN, 21));
		contentPane.add(btnLog);
		
		// Botão de log base e
		
				JButton btnLogE = new JButton("loge n"); 
				btnLogE.addActionListener(new ActionListener() {
						public void actionPerformed(ActionEvent e) {
						valor1 = Double.parseDouble(txtResultado.getText());
						txtResultado.setText("");	
						sinal = "loge n"; 
						logaritmo = Math.log(valor1); 
						 txtResultado.setText (String.valueOf( logaritmo));
						
						
					}
				}); // completion
				btnLogE.setBounds(315, 340, 100, 45);
				btnLogE.setFont(new Font("Arial", Font.PLAIN, 21));
				contentPane.add(btnLogE);
				
				// Botão de log base b
				
				JButton btnLogB = new JButton("logb n"); 
				btnLogB.addActionListener(new ActionListener() {
						public void actionPerformed(ActionEvent e) {
								valor1 = Double.parseDouble(txtResultado.getText());
								txtResultado.setText("");
								sinal = "logaritmo";
				...
				btnLogB.setBounds(315, 395, 100, 45);
				btnLogB.setFont(new Font("Arial", Font.PLAIN, 21));
				contentPane.add(btnLogB);
		...
		button_10.addActionListener(new ActionListener() { 
			public void actionPerformed(ActionEvent e) {
				...
				if (sinal == "logaritmo") {
					logaritmo = Math.log(valor1) / Math.log(valor2);
					txtResultado.setText (String.valueOf(logaritmo));
				}
			}
		}); // completion
